	...
	return (
		<>
			<ThemeProvider theme={theme}>
				...
				>
					...
					<Switch>
						<Route exact path="/">
							...
							/>
							<HomePage classes={classes} menuItems={menuItems} toast={ {...toast,setToast, handleToastClick, handleToastClose}} />
						...
						<Route path="/signin">
							<HomeAppBar
								...
								handleDrawerToggle={handleDrawerToggle}
							/>
							<SignInPage classes={classes} toast={ {...toast,setToast, handleToastClick, handleToastClose}} />
							<Footer classes={classes} />
						</Route>
						<Route path="/signup">
							<HomeAppBar
								...
								handleDrawerToggle={handleDrawerToggle}
							/>
							<SignUpPage classes={classes} toast={ {...toast,setToast, handleToastClick, handleToastClose}} />
				...
				<MySnackbar toast={ {...toast,setToast, handleToastClick, handleToastClose}} />
				<ScrollToTop />
			</ThemeProvider>
		</>
	);
